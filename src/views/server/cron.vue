<template lang="html">
  <div class="cron" :val="value_">
    ...
    <span style="color: #E6A23C; font-size: 12px;">corn从左到右（用空格隔开）：秒  分  小时  月份中的日期  月份  星期中的日期  年份</span></br>
    <span style="color: #E6A23C; font-size: 12px;">以秒页签为例  {  每秒：每秒执行一次 周期(1-5)：每分钟的1-5秒执行 循环：每几秒执行 指定：一分钟的第几秒   }</span>
  </div>
</template>
