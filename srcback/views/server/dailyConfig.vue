<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="SUCCESS 阀值"      prop="success" width="120"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form class="small-space" :model="tempScriptConfig" label-position="left" label-width="80px"
        ...
        <el-form-item label="SUCCESS 阀值" required label-width="145px">
          <el-input type="text" v-model="tempScriptConfig.success">
          </el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      showUpdate($index) {
        ...
        this.tempScriptConfig.success      = shell.success;
