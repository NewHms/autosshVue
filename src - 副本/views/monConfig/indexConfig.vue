        ...
        <el-table-column align="center"   label="阀值" >
          <el-table-column align="center" label="日检阀值" width="180">
            <template slot-scope="scope_alarm" >
              ...
              <dt v-else-if="scope_alarm.row.dailySuccess == '' && scope_alarm.row.dailySuccess == null" class="fail">
                  私有:
              </dt> 
              <dt v-else-if="scope_alarm.row.dailySuccess != ''  && scope_alarm.row.dailySuccess != null">
                  私有: SUC&nbsp;=&nbsp;{{ scope_alarm.row.dailySuccess  }} 
              </dt> 
              <dt v-else class="fail">
                  私有:
              </dt>
          ...
          <el-table-column align="center" label="监控阀值"  width="180">
            <template slot-scope="scope_alarm" >
              ...
              <dt v-else-if="scope_alarm.row.monitorSuccessPriv != ''
                          && scope_alarm.row.monitorSuccessPriv != null" class="fail">
                  通用: SUC&nbsp;=&nbsp;{{ scope_alarm.row.monitorSuccessPriv  }} 
              </dt> 
              <dt v-else-if="scope_alarm.row.monitorWarning != null && scope_alarm.row.monitorCritical != null" class="fail">
                  通用:{{ scope_alarm.row.monitorWarning  }}&nbsp;&lt;=&nbsp;W&nbsp;&lt;&nbsp;{{ scope_alarm.row.monitorCritical }} &lt;=&nbsp;C
              </dt>
              <dt v-else class="fail">
                  通用:
