<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="适配正则"   prop="shellUseRe" width="165%"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="40%">
      <el-form class="small-space" :model="tempScriptConfig" label-position="left" label-width="80px"
        ...
        <el-form-item label="判断规则" label-width="150px">
          <el-select v-if="tempScriptConfig.dailyRule == '空值比对'" 
              v-model="tempScriptConfig.shellUseRe"  placeholder="请选择" style='width: 235px;' :disabled="true"> <!-- 对应列名 clearable 清空当前checkbox-->
            <el-option
           ...
           <el-select v-else 
              v-model="tempScriptConfig.shellUseRe"  placeholder="请选择" style='width: 235px;'> <!-- 对应列名 clearable 清空当前checkbox-->
            <el-option
              v-for ="item in allReRule"
              :key  ="item.ruleId"
              :label="item.ruleType"
